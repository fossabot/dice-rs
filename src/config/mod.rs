...
pub struct Config {
  ...
  #[serde(skip_serializing_if = "Map::is_empty", default = "Config::default_star_types")]
  ...
  fn default_star_types() -> StarTypes {
    map!(
          "O Class Star" => StarType {
            ...
            About 1 in 3,000,000 (0.00003%) of the main-sequence stars in the solar neighborhood are O-type stars.".into()
          },
          "B Class Star" => StarType {
            chance: 0.125,
            part_multy: 0.6,
            make_multy: 0.05,
            rocky: 0.35,
          ...
          "M Class Star" => StarType {
            ...
            unless under exceptional conditions.".into()
          },
          "D Class Star" => StarType {
            chance: 0.75,            
            part_multy: 0.3,
            make_multy: 0.6,
            rocky: 0.25,
          ...
          "Neutron Star" => StarType {
            ...
            combined with gravitational collapse, that compresses the core past the white dwarf star density to that of atomic nuclei.".into()
          },
          "Black Hole" => StarType {
            chance: 0.1,
            part_multy: 0.1,
